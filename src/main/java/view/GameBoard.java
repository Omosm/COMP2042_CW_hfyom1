 ...
 * it also holds the pause menu, debugConsole
 */
public class GameBoard extends JComponent implements KeyListener,MouseListener,MouseMotionListener {
     ...
     */
    private void drawBrick(Brick model,Graphics2D g2d){
        Color tmp = g2d.getColor();

        g2d.setColor(model.getInnerColor());
        g2d.fill(model.getBrick());

        g2d.setColor(model.getBorderColor());
        g2d.draw(model.getBrick());
